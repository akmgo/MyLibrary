    ...
    var body: some View {
        ...
        ZStack {
            ...
            GeometryReader { geo in
                Circle()
                    .fill(isDark ? Color.twBlue600.opacity(0.1) : Color.twBlue300.opacity(0.3))
                    .frame(width: 500, height: 500)
                    .blur(radius: 100)
                    .position(x: 0, y: 0)
                Circle()
                    .fill(isDark ? Color.twPurple600.opacity(0.1) : Color.twPurple300.opacity(0.3))
            ...
            VStack(spacing: 24) {
                HStack {
                    ...
                    Text("\(readingCount) 本")
                        ...
                        .foregroundColor(isDark ? .twSlate300 : .twSlate500)
                }
                ...
                if let book = heroBook {
                    ...
                    VStack(spacing: 16) {
                        Image(systemName: "book.closed")
                            .font(.system(size: 48))
                            .foregroundColor(.twSlate400.opacity(0.3))
                        Text("目前没有正在阅读的书籍")
                            .font(.headline)
                            .italic()
...
#Preview("总装配效果") {
    ...
    @Previewable @State var activeCoverID: String = ""
